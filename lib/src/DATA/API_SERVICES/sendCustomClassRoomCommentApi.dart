...
class SendCustomClassRoomCommentApi {
  Future<bool> sendCustomClassRoomComments(
      Map<String, String> comments, List<File>? _filePickedList) async {
    print("SendCustomClassRoomComments before API: $comments");
    try {
      // create multipart request
      var uri = Uri.parse(ApiEndpoints.sendCustomClassRoomCommentApi);
      ...
      print(
          "SendCustomClassRoomComments status code -- ${response.statusCode}");
