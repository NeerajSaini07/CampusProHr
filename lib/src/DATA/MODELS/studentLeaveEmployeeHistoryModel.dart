class StudentLeaveEmployeeHistoryModel {
  String? leaveDayType;
  String? name;
  String? requestorId;
  ...
  String? toDate;
  String? status;
  StudentLeaveEmployeeHistoryModel(
      {this.leaveDayType,
      this.name,
      this.requestorId,
      this.requestorPhone,
  ...
  StudentLeaveEmployeeHistoryModel.fromJson(Map<String, dynamic> json) {
    ...
    status = json['LeaveStatus'] != null ? json['LeaveStatus'] : "";
  }
