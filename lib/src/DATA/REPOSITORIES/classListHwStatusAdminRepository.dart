...
abstract class ClassListHwStatusAdminRepositoryAbs {
  Future<List<ClassListHwStatusAdminModel>> getClass(
      Map<String, String?> requestPayload);
}

class ClassListHwStatusAdminRepository
    extends ClassListHwStatusAdminRepositoryAbs {
  final ClassListHwStatusAdminApi _api;
  ClassListHwStatusAdminRepository(this._api);
