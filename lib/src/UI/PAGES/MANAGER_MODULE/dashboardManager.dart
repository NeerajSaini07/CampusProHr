...
class DashboardManager extends StatefulWidget {
  static const routeName = "/dashboard-manager";
...
class _DashboardManagerState extends State<DashboardManager> {
      ...
      case 64:
        {
          ...
          if (flag.toLowerCase() == "f") {
                  ...
                  child: BlocProvider<GetPopupAlertListCubit>(
                    ...
                    child: BlocProvider<GetPopupMessageListCubit>(
                      create: (_) => GetPopupMessageListCubit(
                          GetPopupMessageListRepository(
                              GetPopupMessageListApi())),
            ...
            // return Navigator.pushNamed(context, PopUpConfigureAdmin.routeName);
          } else {
            print(url);
            appBarNameForWeb = "PopUp Configure";
            return gotoWeb(url: url, name: "PopUp Configure");
          }
        }
      case 38:
        {
                    ...
                    child: Column(
                      children: [
                        buildEmployeeHomeCategorys(
                            title: "Academics",
                            quickList: managerCategoryListAcademics),
                        SizedBox(
                          height: 10,
                        ),
                        buildEmployeeHomeCategorys(
                            title: "Circulars",
                            quickList: managerCategoryListCirculars),
                        SizedBox(
                          height: 10,
                        ),
                      ],
  ...
  //           shrinkWrap: true,
  //           scrollDirection: Axis.horizontal,
  //           itemCount: managerCategoryList.length,
  //           itemBuilder: (context, i) {
  //             var item = managerCategoryList[i];
  //             return Container(
  //               width: 150,
  //               height: 40,
  //               child: InkWell(
