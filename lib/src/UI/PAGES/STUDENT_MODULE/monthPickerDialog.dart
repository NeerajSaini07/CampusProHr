...
class _MonthPickerDialogState extends State<_MonthPickerDialog> {
  ...
  Widget buildButtonBar(
    ...
    return ButtonTheme(
      ...
      TextButton(
        onPressed: () {
          print("selectedDate on Month Picker : $selectedDate");
                ...
                children: <Widget>[
                  ...
                  Row(
                      ...
                      children: <Widget>[
                        ...
                        // if (isYearSelection!)
                        //   Text(
                        //     '${DateFormat.y(locale).format(DateTime(displayedPage! - 10))}',
    ...
    return TextButton(
      onPressed: callback,
         ...
         backgroundColor:  date.month == selectedDate!.month && date.year == selectedDate!.year
              ...
              : null,
         textStyle: TextStyle(color: date.month == selectedDate!.month && date.year == selectedDate!.year
              ? accentColor //TODO
  ...
  Widget _getYearButton(int year, ThemeData theme, String locale) {
    ...
    return TextButton(
      ...
      style: TextButton.styleFrom(
         ...
         textStyle: TextStyle(color:year == selectedDate!.year
          ? accentColor //TODO
